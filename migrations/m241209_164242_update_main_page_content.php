...
/**
 * Class m241209_164242_update_main_page_content
 */
class m241209_164242_update_main_page_content extends Migration
{
    /**
     * {@inheritdoc}
     */
...
HTML;
        ...
        // Update the content where the title is "Home page"
        $this->update('pages', ['content' => $content], ['title' => 'Home page']);
    }
    ...
    {
        $this->update('pages', [
            'content' => '<h1>Original Home Page Content</h1><p>This is the original content of the Home page.</p>'
        ], ['title' => 'Home page']);
    }
}
