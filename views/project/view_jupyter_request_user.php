	...
	<table class="table table-striped">
		<tbody>
			<tr>
				...
				<td class="col-md-6 text-left" scope="col"><?= $details->cores ?> (used <?=round($usage['cpu']/1000,2)?> cores/server οn average)</td>
			</tr>
			<tr>
				<th class="col-md-6 text-right" scope="col">RAM:</th>
				<td class="col-md-6 text-left" scope="col"><?= $details->ram ?> GBs (used <?=round($usage['ram'],2)?> GBs/server οn average)</td>
			</tr>
			<tr>
				<th class="col-md-6 text-right" scope="col">Jupyter server type:</th>
				<td class="col-md-6 text-left" scope="col"><?= $image ?> </td>
			</tr>
			<tr>
				<th class="col-md-6 text-right" scope="col">Active Jupyter Servers:</th>
				<td class="col-md-6 text-left" scope="col"><?= $active_servers ?></td>
			</tr>
			<tr>
				<th class="col-md-6 text-right" scope="col">Total Jupyter Servers:</th>
				<td class="col-md-6 text-left" scope="col"><?=$number_of_users?></td>
			</tr>
		</tbody>
	</table>
</div>
