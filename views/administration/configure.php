...
<div class="form_container">
	...
	<div class="row category-tabs">
		<div class="col-md-3 tab-button <?=$activeButtons[0]?>" data-controlling="tab-general" id='general-button' ><div class="button-text">General</div></div>
		...
		<div class="col-md-3 tab-button <?=$activeButtons[3]?>" data-controlling="tab-cold-storage-autoaccept" id='cold-button'><div class="button-text"> Cold storage projects</div></div>
	...
	<div class="row">
		<div class="col-md-3"><?=Html::dropDownList('currentUserType',$hiddenUser,$userTypes,
									['id'=>'typeDropdown', 'class'=>(empty($activeTabs[0])?'' : 'dropdown-hidden')])?>
	...
	<div class="form-group">
        ...
        <?= Html::a('<i class="fas fa-times"></i> Cancel', ['/request/index'], ['class'=>'btn btn-default']) ?>
    </div>
	<?php ActiveForm::end(); ?>
</div>