...
{?>
<div class="col-md-5 col-md-offset-4">
	<?= $form->field($user_notifications, 'project_decision')->checkBox(['label'=>'', 'disabled'=>false])->label('Project decision') ?>
</div>
<div class="col-md-5 col-md-offset-4">
	<?= $form->field($user_notifications, 'expires_30')->checkBox(['label'=>'', 'disabled'=>false])->label('Project expires in 30 days') ?>
</div>
<div class="col-md-5 col-md-offset-4">
