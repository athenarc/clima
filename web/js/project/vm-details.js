$(document).ready(function(){
    ...
    $(".start-btn").click(function(){
        ...
        var status=$("#status-span").html().trim();
        /*
    ...
    function startVM()
    {
        var vm_id=$("#hidden_vm_field").val();
        $.ajax({
            url: "index.php?r=project/start-vm",
            type: "GET",
            data: { "vm_id": vm_id },
            dataType: "html",
            success: function (data) 
    ...
    function stopVM()
    {
        var vm_id=$("#hidden_vm_field").val();
        $.ajax({
            url: "index.php?r=project/stop-vm",
            type: "GET",
            data: { "vm_id": vm_id },
            dataType: "html",
            success: function (data) 
    ...
    function rebootVM()
    {
        var vm_id=$("#hidden_vm_field").val();
        $.ajax({
            url: "index.php?r=project/reboot-vm",
            type: "GET",
            data: { "vm_id": vm_id },
            dataType: "html",
            success: function (data) 
    ...
    {
        var vm_id=$("#hidden_vm_field").val();
        var previous=$("#status-span").html().trim();
        
        $.ajax({
            url: "index.php?r=project/get-vm-status",
            type: "GET",
            data: { "vm_id": vm_id },
            dataType: "html",
            success: function (data) 
