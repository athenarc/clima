...
class Project extends \yii\db\ActiveRecord
{
    ...
    public static function getActiveProjectsOwner()
    {
        ...
        $query->select(['pr.id','p.id as project_id','pr.name','pr.end_date', 'pr.duration','pr.submission_date','pr.approval_date','pr.status','pr.viewed', 'pr.project_type','username'])
              ->from('project as p')
